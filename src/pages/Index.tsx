          ...
          <div className="space-y-6">
            ...
            <div className="retro-inset p-3">
              ...
              <p className="text-sm mb-4">
                This AI system enables lawyers to automate routine tasks, analyze documents, and
                generate professional legal content with unprecedented speed and accuracy.
              </p>
